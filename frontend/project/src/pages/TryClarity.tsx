  ...
  return (
    <div className="min-h-screen bg-[#f5f5f7] dark:bg-gray-900 flex flex-col">
      ...
      <div className="grid md:grid-cols-3 gap-6 px-8 mb-14">
        ...
        <FeatureCard
          title="Teach Me"
          description="Enhance your understanding by teaching concepts to Clarity. As your AI student, Clarity asks thoughtful questions that help you master the material through explanation."
          icon={<svg className="w-7 h-7" fill="none" viewBox="0 0 24 24" stroke="currentColor">
            <path strokeLinecap="round" strokeLinejoin="round" strokeWidth={2} d="M12 6.253v13m0-13C10.832 5.477 9.246 5 7.5 5S4.168 5.477 3 6.253v13C4.168 18.477 5.754 18 7.5 18s3.332.477 4.5 1.253m0-13C13.168 5.477 14.754 5 16.5 5c1.747 0 3.332.477 4.5 1.253v13C19.832 18.477 18.247 18 16.5 18c-1.746 0-3.332.477-4.5 1.253" />
          </svg>}
          isLarge={true}
